  ...
  function updateBreadcrumbs(sequenceArray, percentageString) {
    ...
    entering.append('svg:polygon')
        ...
        .style('fill', function (d) {
            //adding colors for when its ok warning or error
            if(d.name == 'ok'){return okspectrumcolors(d.name);}
            if(d.name == 'warning'){return warningspectrumcolors(d.name);}
            if(d.name == 'error'){return errorspectrumcolors(d.name);}
